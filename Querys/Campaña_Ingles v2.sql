...
FROM ODSMGR.LOE_SOVLCUR
        ...
        LEFT JOIN ODSMGR.STUDENT_COURSE C ON SOVLCUR_PIDM = C.PERSON_UID AND C.REGISTRATION_STATUS IN ('RE','RW','RA','WC','RF','RO','IA') AND C.ACADEMIC_PERIOD IN ('221703','221704')
