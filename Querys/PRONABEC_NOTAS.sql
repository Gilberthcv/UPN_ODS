...
SELECT SHRTCKN_PIDM, SPRIDEN_ID, GORADID_ADDITIONAL_ID AS DNI, SPRIDEN_FIRST_NAME AS NOMBRES, SUBSTR(SPRIDEN_LAST_NAME,1,INSTR(SPRIDEN_LAST_NAME,'/',1,1)-1) AS APELLIDO_PATERNO
    ...
    , SHRTCKN_TERM_CODE AS SEMESTRE_ACADÉMICO, SHRTCKN_CRN, SHRTCKN_SUBJ_CODE, SHRTCKN_CRSE_NUMB, NVL(SHRTCKN_LONG_COURSE_TITLE,SHRTCKN_CRSE_TITLE) AS NOMBRE_CURSO
    , C.CICLO_CURSO, SHRTCKG_CREDIT_HOURS AS CREDITOS_CURSO, SHRTCKG_GRDE_CODE_FINAL AS NOTA_CURSO
FROM SHRTCKN, SHRTCKG G, SPRIDEN, GORADID, LOE_SOVLCUR U, CICLO C
