...
FROM
    ((((((((((((ODSMGR.ACADEMIC_STUDY a 
        LEFT JOIN ODSMGR.STUDENT_COHORT b ON 
        ...
        LEFT JOIN ODSMGR.STUDENT_ACTIVITY d ON 
            ...
            d.ACTIVITY = 'ITO' )
        LEFT JOIN ODSMGR.ADMISSIONS_APPLICATION e ON
        ...
        LEFT JOIN ODSMGR.HOLD i ON
            a.PERSON_UID = i.PERSON_UID AND
            i.HOLD IN ('C1','F1','M1') AND
            i.ACTIVE_HOLD_IND = 'Y' )
        LEFT JOIN ODSMGR.LOE_SPRIDEN j ON
        ...
        LEFT JOIN (SELECT 
            ...
            FROM 
                ODSMGR.PS_BI_HDR k1
                    INNER JOIN ODSMGR.PS_BI_LINE k2 ON
...
WHERE
    ...
    --AND 
    --j.SPRIDEN_ID IN ('N00267826')
    --j.SPRIDEN_ID IN ('N00279512','N00279459','N00279511')
    j.SPRIDEN_ID IN ('N00279527','N00279506','N00279520')
ORDER BY 1 DESC;
