...
SELECT CLIENTE
    ...
    , ID_BANCO
    , CASE 
        WHEN PAGO = 'CC' THEN PAGO || ' - CREDIT CARD' 
        WHEN PAGO = 'CSH' THEN PAGO || ' - CASH' 
        WHEN PAGO = 'CV' THEN PAGO || ' - CORPORATE VOUCHER' 
        WHEN PAGO = 'DC' THEN PAGO || ' - DEBIT CARD' 
        WHEN PAGO = 'PC' THEN PAGO || ' - PROCURENMENT CARD' 
