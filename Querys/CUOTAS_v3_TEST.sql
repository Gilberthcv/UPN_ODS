...
FROM
    (
      SELECT S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, TRIM(SUBSTR(TRIM(S_CUO_CONCEPTO),1,14)) S_CUO_CONCEPTO, SUM(N_CUO_MONTO_LINEA) AS MONTO
      FROM CUOTAS
      WHERE UPPER(S_CUO_CONCEPTO) LIKE '%2DA%'
      GROUP BY S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, TRIM(SUBSTR(TRIM(S_CUO_CONCEPTO),1,14))
    ) rept2
...
WHERE 
    --CASO 3
    --S_SEM_CODIGO = '219402'
    --AND S_ALU_CODIGO = 'N00017834'
    --AND S_ALU_CODIGO = 'N00158946'
    
    --CASO 6
    --S_SEM_CODIGO = '219402'
    --AND S_ALU_CODIGO = 'N00057355'
    --AND S_ALU_CODIGO = 'N00115121'
    
    --CASO 10
    --S_SEM_CODIGO = '219402'
    --AND S_ALU_CODIGO = 'N00085379'
    --S_SEM_CODIGO = '218413'
    --AND S_ALU_CODIGO = 'N00175388'
    
    --CASO 11
    --S_SEM_CODIGO = '218413'
    --AND S_ALU_CODIGO = 'N00085460'
    ...
    --CASO 13*
    --S_SEM_CODIGO = '219402'
    --AND S_ALU_CODIGO = 'N00016251'
    
    --CASO 17
    --S_SEM_CODIGO = '219501'
    --AND S_ALU_CODIGO = 'N00041928'
    
    --S_SEM_CODIGO = '218434'
    --AND S_ALU_CODIGO = 'N00190406'
    S_SEM_CODIGO = '217434'
    AND S_ALU_CODIGO = 'N00018140'
ORDER BY 1,2,3,6;