...
GROUP BY B.PO_REF, A.BILL_TO_CUST_ID, A.INVOICE, A.BILL_STATUS, D.ITEM_STATUS
    , CASE WHEN D.ITEM_STATUS = 'C' THEN Y.ENTRY_TYPE END, Y.ENTRY_REASON, A.BILL_STATUS, D.ITEM_STATUS, A.INVOICE_AMOUNT, A.INVOICE_DT, 
    CASE WHEN  TO_CHAR(D.DUE_DT,'YYYY-MM-DD') IS NULL 
        THEN (CASE WHEN A.PYMNT_TERMS_CD IN ('000','0000','00000') THEN TO_CHAR(A.DUE_DT,'YYYY-MM-DD') ELSE TO_CHAR(F.DUE_DT,'YYYY-MM-DD') END) 
