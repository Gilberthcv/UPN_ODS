...
FROM 
    ...
    FROM ODSMGR.SHRTRIT, ODSMGR.SHRTRAM/*, ODSMGR.SHRTRCR*/, ODSMGR.SHRTRCE
    WHERE SHRTRIT_PIDM = SHRTRAM_PIDM AND SHRTRIT_SEQ_NO = SHRTRAM_TRIT_SEQ_NO 
	    ...
	    LEFT JOIN ODSMGR.LOE_SPRIDEN b ON a.SHRTRIT_PIDM = b.SPRIDEN_PIDM AND b.SPRIDEN_CHANGE_IND IS NULL
	    LEFT JOIN ODSMGR.STVSBGI c ON a.SHRTRIT_SBGI_CODE = c.STVSBGI_CODE
	    LEFT JOIN ODSMGR.LOE_SOVLCUR d ON a.SHRTRIT_PIDM = d.SOVLCUR_PIDM AND a.SHRTRAM_LEVL_CODE = d.SOVLCUR_LEVL_CODE AND d.SOVLCUR_CACT_CODE = 'ACTIVE' AND d.SOVLCUR_CURRENT_IND = 'Y' AND d.SOVLCUR_LMOD_CODE = 'LEARNER'
