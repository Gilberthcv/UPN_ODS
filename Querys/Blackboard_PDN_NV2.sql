...
FROM
    ...
    FROM STUDENT_COURSE a INNER JOIN ACADEMIC_STUDY b ON
            a.PERSON_UID = b.PERSON_UID AND a.ACADEMIC_PERIOD = b.ACADEMIC_PERIOD --AND b.STUDENT_LEVEL = 'UG' --NIVEL
    UNION
...
AND c.ACADEMIC_PERIOD IN ('218997'
,'218988'
,'218986'
,'218985'
,'218942'
...
FROM
    (SELECT DISTINCT a.PERSON_UID, a.ACADEMIC_PERIOD, a.COURSE_REFERENCE_NUMBER, 'S' AS ROLE FROM STUDENT_COURSE a INNER JOIN ACADEMIC_STUDY b ON
        a.PERSON_UID = b.PERSON_UID AND a.ACADEMIC_PERIOD = b.ACADEMIC_PERIOD AND b.ENROLLMENT_STATUS = 'EL' --AND b.STUDENT_LEVEL = 'UG' --NIVEL
    UNION
...
SELECT DISTINCT
    ...
    , NVL(c.TITLE_LONG_DESC,c.TITLE_SHORT_DESC) AS COURSE_NAME
...
AND a.ACADEMIC_PERIOD IN ('218997'
,'218988'
,'218986'
,'218985'
,'218942'
