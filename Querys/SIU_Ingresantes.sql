...
SELECT --A.PERSON_UID, A.ID, A.STUDENT_LEVEL, CASE WHEN J.MAESTRIA IS NOT NULL THEN A.PROGRAM ||' - '|| J.MAESTRIA ELSE A.PROGRAM END AS PROGRAMA, 
...
GROUP BY --A.PERSON_UID, A.ID, A.STUDENT_LEVEL, CASE WHEN J.MAESTRIA IS NOT NULL THEN A.PROGRAM ||' - '|| J.MAESTRIA ELSE A.PROGRAM END, 
	CASE WHEN C.COHORT IN ('REINGRESO','NEW_REING') THEN 2
		WHEN A.STUDENT_POPULATION = 'N' THEN 1
		WHEN A.ADMISSIONS_POPULATION = 'II'
			OR (A.ADMISSIONS_POPULATION <> 'RE' AND D.STUDENT_ATTRIBUTE = 'TINT')
	...
	, CASE WHEN I.DNI IS NOT NULL AND LENGTH(I.DNI) < 9 THEN '9233' END
	, CASE WHEN I.DNI IS NOT NULL AND LENGTH(I.DNI) < 9 THEN '85' END
	, CASE WHEN I.DNI IS NOT NULL AND LENGTH(I.DNI) < 9 THEN '140101' END
	, NULL, NULL, NULL, NULL
	, CASE A.COLLEGE
		WHEN 'AR' THEN 15
		WHEN 'SA' THEN 11
	...
	, CASE (CASE WHEN A.PROGRAM = 'MOINTL' THEN J.MAESTRIA ELSE A.PROGRAM END)
		...
		WHEN 'TFI-WA' THEN 57
		ELSE 999999 END
	, TO_CHAR(H.APPLICATION_DATE,'DD/MM/YYYY')
	, CASE A.ADMISSIONS_POPULATION
		WHEN 'WE' THEN 3
		WHEN 'WA' THEN 8
		WHEN 'DI' THEN 3
