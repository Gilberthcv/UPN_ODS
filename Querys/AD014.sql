...
WHERE
    ...
    AND a.ACADEMIC_PERIOD IN ('218942')
    AND j.SPRIDEN_ID IN ('N00002655','N00018579')
ORDER BY 1 DESC;

SELECT PERSON_UID, ID, NAME, ACADEMIC_PERIOD,ACADEMIC_PERIOD_ADMITTED, PROGRAM, PROGRAM_DESC, STUDENT_LEVEL, CAMPUS FROM ACADEMIC_STUDY
WHERE ACADEMIC_PERIOD = ACADEMIC_PERIOD_ADMITTED AND PERSON_UID IN (18579,2655) AND ACADEMIC_PERIOD IN ('218942');
