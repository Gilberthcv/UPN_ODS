...
SELECT A.DECODE_PIDM, SPRIDEN_ID, SPRIDEN_FIRST_NAME ||' '|| REPLACE(SPRIDEN_LAST_NAME,'/',' ') AS NOMBRE_ESTUDIANTE, A.DECODE_SEQ, B.QUALIFYING_PAPER_TYPE_CODE
	...
	, MAX(CASE WHEN A.GORSDAV_ATTR_NAME = 'FEC_TRAB' THEN A.DECODE_VALUE END) AS FEC_TRAB
...
WHERE A.GORSDAV_ATTR_NAME IN ('TESIS','URL_TESIS','ACTO_TIP','MODALIDAD','RESO_NUM','RESO_FEC','DIPL_NUM','DIPL_FEC','DIPL_TIP_EMI','REG_LIBRO','REG_FOLIO','REG_REGISTRO','FEC_TRAB')
