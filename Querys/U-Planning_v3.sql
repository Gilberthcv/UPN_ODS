...
WHERE a.ACADEMIC_PERIOD = b.ACADEMIC_PERIOD(+) AND a.COURSE_REFERENCE_NUMBER = b.COURSE_REFERENCE_NUMBER(+)
    ...
    AND a.ACADEMIC_PERIOD IN ('218434','218533');
...
WHERE b.STUDENT_LEVEL = 'UG' AND a.ACADEMIC_PERIOD IN ('218434','218533');
...
FROM ACADEMIC_STUDY
WHERE STUDENT_LEVEL = 'UG' AND ACADEMIC_PERIOD IN ('218434','218533');
