...
SELECT DISTINCT
    ...
    , SSBSECT_INSM_CODE AS MET_EDUC, SSBSECT_CAMP_CODE AS CAMPUS, SSRMEET_USER_ID AS USUARIO_ACTIVIDAD, SPRIDEN_LAST_NAME ||' '|| SPRIDEN_FIRST_NAME AS NOMBRE_USUARIO
...
FROM SSBSECT, SSRMEET, SPRIDEN
WHERE SSBSECT_TERM_CODE = SSRMEET_TERM_CODE AND SSBSECT_CRN = SSRMEET_CRN
    AND SUBSTR(SSRMEET_USER_ID,2) = SPRIDEN_ID
