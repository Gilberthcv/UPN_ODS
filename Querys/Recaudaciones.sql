...
/*Concepto (matrícula, pensiones, servicios)
Monto
Transacción
Canal de recaudación (banco, caja, portal)
Tipo de estudiantes (nuevo, continuo, reingreso, new reingreso)*/
...
FROM PS, SPRIDEN, LOE_SOVLCUR, STUDENT_COHORT
