...
WHERE f.SPRIDEN_CHANGE_IND IS NULL AND SUBSTR(f.SPRIDEN_ID,1,1) = 'N' AND e.INSTRUCTION_METHOD = 'V' 
AND e.CAMPUS IN ('TML','TSI') 
AND SUBSTR(c.ACADEMIC_PERIOD,4,1) IN ('3','4','5','7','8','9') 
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '3' --PDN
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '4' --UG
--AND SUBSTR(c.ACADEMIC_PERIOD,4,1) = '5' --WA
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '7' --INGLES
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '8' --MA
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '9' --EC
AND d.MIN_START_DATE <= '04/07/2018' AND d.MAX_END_DATE >= '04/07/2018'
...
WHERE SUBSTR(a.TERM_CODE,4,1) IN ('3','4','5','7','8','9') 
AND a.START_DATE <= '04/07/2018' AND a.END_DATE >= '04/07/2018';
...
WHERE a.INSTRUCTION_METHOD = 'V' 
AND a.CAMPUS IN ('TML','TSI') 
AND SUBSTR(a.ACADEMIC_PERIOD,4,1) IN ('3','4','5','7','8','9') 
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '3' --PDN
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '4' --UG
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '5' --WA
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '7' --INGLES
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '8' --MA
--AND SUBSTR(a.ACADEMIC_PERIOD,4,1) = '9' --EC
AND b.MIN_START_DATE <= '04/07/2018' AND b.MAX_END_DATE >= '04/07/2018'
