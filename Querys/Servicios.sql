...
SELECT --* 
    ...
    , SVRSVPR_SRVC_CODE, SVVSRVC_DESC, SVRSVPR_ESTIMATED_DATE, SVRSVPR_RECEPTION_DATE
...
WHERE SVRSVPR_SRVC_CODE = SVVSRVC_CODE
    ...
    AND ((SVRSVPR_RECEPTION_DATE BETWEEN '29/07/2019' AND '06/08/2019')
        OR (SVRSVPR_ESTIMATED_DATE BETWEEN '29/07/2019' AND '06/08/2019'));
