...
SELECT B.PO_REF AS S_SEM_CODIGO, 
    ...
    CASE WHEN  TO_CHAR(D.DUE_DT,'YYYY-MM-DD') IS NULL 
        THEN (CASE WHEN (A.PYMNT_TERMS_CD = 00000) THEN TO_CHAR(A.DUE_DT,'YYYY-MM-DD') ELSE TO_CHAR(F.DUE_DT,'YYYY-MM-DD') END) 
...
GROUP BY B.PO_REF, A.BILL_TO_CUST_ID, A.INVOICE, Y.ENTRY_TYPE, Y.ENTRY_REASON, A.BILL_STATUS, A.INVOICE_AMOUNT, A.INVOICE_DT, 
    ...
    --CASE WHEN D.ITEM_STATUS = 'C' THEN NVL(PY.PAYMENT_DT,Y.ACCOUNTING_DT) ELSE NULL END,
...
FROM
    (
      SELECT S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, S_CUO_CONCEPTO, SUM(N_CUO_MONTO_LINEA) AS MONTO
      FROM CUOTAS
      ...
      GROUP BY S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, S_CUO_CONCEPTO
    ) pension
    left join (
...
FROM
    (
      SELECT S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, SUBSTR(S_CUO_CONCEPTO,1,14) S_CUO_CONCEPTO, SUM(N_CUO_MONTO_LINEA) AS MONTO
      FROM CUOTAS
      WHERE UPPER(S_CUO_CONCEPTO) LIKE '%2DA%'
      GROUP BY S_SEM_CODIGO, S_ALU_CODIGO, S_CUO_INVOICE, ENTRY_TYPE, ENTRY_REASON, S_CUO_INVOICE_STATUS, N_CUO_INVOICE_AMOUNT, N_CUO_BALANCE, D_CUO_FECHA_EMISION, D_CUO_FECHA_VENCIMIENTO, D_CUO_FECHA_PAGO, S_CUO_TIPO_PAGO, N_CUO_CUOTA, SUBSTR(S_CUO_CONCEPTO,1,14)
    ) rept2
...
WHERE 
    --CASO 1
    /*S_SEM_CODIGO = '217434'
    AND S_ALU_CODIGO = 'N00015572'*/
    --CASO 2
    /*S_SEM_CODIGO = '218512'
    AND S_ALU_CODIGO = 'N00172457'*/
    --CASO 3
    /*S_SEM_CODIGO = '218413'
    AND S_ALU_CODIGO = 'N00186317'*/
    --CASO 4
    /*S_SEM_CODIGO = '217534'
    AND S_ALU_CODIGO = 'N00020851'*/
    --CASO 5
    /*S_SEM_CODIGO = '218512'
    AND S_ALU_CODIGO = 'N00182162'*/
    
    /*S_SEM_CODIGO = '219402'
    AND S_ALU_CODIGO = 'N00123797'*/
    S_SEM_CODIGO = '218434'
    AND S_ALU_CODIGO = 'N00190406'
