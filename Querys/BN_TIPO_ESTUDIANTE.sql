...
WHERE P.PERIODO_ANTERIOR = D.STVTERM_CODE AND P.PERIODO_ANTERIOR = F.TERM_CODE
    AND P.PERIODO_ACTUAL_LBL > '2019-0'
	--AND P.PERIODO_ACTUAL IN ('220435','220534')
...
-------------------------------------------------
--MERGE
MERGE INTO BN_TIPO_ESTUDIANTE USING (
...
) DIF ON BN_TIPO_ESTUDIANTE.SHRTCKN_PIDM = DIF.SHRTCKN_PIDM AND BN_TIPO_ESTUDIANTE.PERIODO_ACTUAL = DIF.PERIODO_ACTUAL
WHEN MATCHED THEN
    UPDATE SET BN_TIPO_ESTUDIANTE.SPRIDEN_ID = DIF.SPRIDEN_ID
        , BN_TIPO_ESTUDIANTE.MAX_PERIODO_HISTORIA = DIF.MAX_PERIODO_HISTORIA
        , BN_TIPO_ESTUDIANTE.FECHA_INICIO = DIF.FECHA_INICIO
        , BN_TIPO_ESTUDIANTE.FECHA_FIN = DIF.FECHA_FIN
        , BN_TIPO_ESTUDIANTE.MAX_PERIODO_EGRESO = DIF.MAX_PERIODO_EGRESO
        , BN_TIPO_ESTUDIANTE.FLAG_INTERCAMBIO_OUT = DIF.FLAG_INTERCAMBIO_OUT
        , BN_TIPO_ESTUDIANTE.TIPO_ESTUDIANTE = DIF.TIPO_ESTUDIANTE
